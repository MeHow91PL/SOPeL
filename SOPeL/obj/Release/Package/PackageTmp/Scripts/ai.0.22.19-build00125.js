...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        (function (_InternalMessageId) {
            _InternalMessageId[_InternalMessageId["NONUSRACT_BserDoesNotSupportLocalStorage"] = 0] = "NONUSRACT_BserDoesNotSupportLocalStorage";
            _InternalMessageId[_InternalMessageId["NONUSRACT_BserCannotReadLocalStorage"] = 1] = "NONUSRACT_BserCannotReadLocalStorage";
            _InternalMessageId[_InternalMessageId["NONUSRACT_BserCannotReadSessionStorage"] = 2] = "NONUSRACT_BserCannotReadSessionStorage";
            _InternalMessageId[_InternalMessageId["NONUSRACT_BserCannotWriteLocalStorage"] = 3] = "NONUSRACT_BserCannotWriteLocalStorage";
            _InternalMessageId[_InternalMessageId["NONUSRACT_BserCannotWriteSessionStorage"] = 4] = "NONUSRACT_BserCannotWriteSessionStorage";
            _InternalMessageId[_InternalMessageId["NONUSRACT_BserFailedRemovalFromLocalStorage"] = 5] = "NONUSRACT_BserFailedRemovalFromLocalStorage";
            _InternalMessageId[_InternalMessageId["NONUSRACT_BserFailedRemovalFromSessionStorage"] = 6] = "NONUSRACT_BserFailedRemovalFromSessionStorage";
        ...
        var _InternalLogging = (function () {
            ...
            _InternalLogging.thInternalNonUserActionable = function (severity, message) {
            ...
            _InternalLogging.thInternalUserActionable = function (severity, message) {
                if (this.enableDebugExceptions()) {
                    th message;
                }
                else {
            ...
            _InternalLogging.setMaxInternalMessageLimit = function (limit) {
                if (!limit) {
                    th new Error('limit cannot be undefined.');
                }
            ...
            Util.getStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BserCannotReadLocalStorage, "Bser failed read of local storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, message);
                    }
                }
                return null;
            };
            Util.setStorage = function (name, data) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BserCannotWriteLocalStorage, "Bser failed write to local storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, message);
                    }
                }
                return false;
            ...
            Util.removeStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BserFailedRemovalFromLocalStorage, "Bser failed removal of local storage item. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, message);
                    }
                }
                return false;
            ...
            Util.getSessionStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BserCannotReadSessionStorage, "Bser failed read of session storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, message);
                    }
                }
                return null;
            };
            Util.setSessionStorage = function (name, data) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BserCannotWriteSessionStorage, "Bser failed write to session storage. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, message);
                    }
                }
                return false;
            ...
            Util.removeSessionStorage = function (name) {
                ...
                if (storage !== null) {
                    try {
                        ...
                        var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BserFailedRemovalFromSessionStorage, "Bser failed removal of session storage item. " + Util.getExceptionName(e), { exception: Util.dump(e) });
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, message);
                    }
                }
                return false;
        ...
        var AjaxMonitor = (function () {
            ...
            AjaxMonitor.prototype.instrumentOpen = function () {
                ...
                XMLHttpRequest.prototype.open = function (method, url, async) {
                    try {
                        ...
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_FailedMonitorAjaxOpen, "Failed to monitor XMLHttpRequest.open, monitoring data for this ajax call may be incorrect.", {
            ...
            AjaxMonitor.prototype.onAjaxComplete = function (xhr) {
                ...
                if (xhr.ajaxData.ajaxTotalDuration < 0) {
                    ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_FailedMonitorAjaxDur, "Failed to calculate the duration of the ajax call, monitoring data for this ajax call won't be sent.", {
                        ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(xhr),
    ...
    (function (ApplicationInsights) {
        ...
        var Serializer = (function () {
            ...
            Serializer._serializeObject = function (source, name) {
                ...
                var output = {};
                if (!source) {
                    ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_CannotSerializeObject, "cannot serialize object because it is null or undefined", { name: name }));
                    return output;
                }
                if (source[circularReferenceCheck]) {
                    ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_CircularReferenceDetected, "Circular reference detected while serializing object", { name: name }));
                    return output;
                }
                if (!source.aiDataContract) {
                    if (name === "measurements") {
                        ...
                        ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_CannotSerializeObjectNonSerializable, "Attempting to serialize an object which does not implement ISerializable", { name: name }));
                        try {
                            JSON.stringify(source);
                            output = source;
                        }
                        catch (e) {
                            ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, e && typeof e.toString === 'function' ? e.toString() : "Error serializing object");
                        }
                    }
                    return output;
                }
            ...
            Serializer._serializeArray = function (sources, name) {
                ...
                if (!!sources) {
                    if (!ApplicationInsights.Util.isArray(sources)) {
                        ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_ItemNotInArray, "This field was specified as an array in the contract but the item is not an array.\r\n", { name: name }));
                    }
                    else {
                        output = [];
                ...
                if (map) {
                    ...
                    for (var field in map) {
                        ...
                        if (expectedType === "string") {
                            ...
                            ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, output[field]);
                        }
                    }
                }
                return output;
            ...
            var _SessionManager = (function () {
                ...
                _SessionManager.prototype.initializeAutomaticSessionWithData = function (sessionData) {
                    ...
                    if (this.automaticSession.renewalDate == 0) {
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_SessionRenewalDateIsZero, "AI session renewal date is 0, session will be reset."));
                    }
                };
                _SessionManager.prototype.renew = function () {
                    ...
                    if (!ApplicationInsights.Util.canUseLocalStorage()) {
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_BserDoesNotSupportLocalStorage, "Bser does not support local storage. Session durations will be inaccurate."));
                    }
                };
        ...
        (function (Context) {
            ...
            var User = (function () {
                ...
                User.prototype.setAuthenticatedUserContext = function (authenticatedUserId, accountId) {
                    ...
                    if (isInvalidInput) {
                        ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_SetAuthContextFailedAccountName, "Setting auth user context failed. " +
        ...
        var Sender = (function () {
            ...
            Sender.prototype.send = function (envelope) {
                ...
                try {
                    ...
                    if (!envelope) {
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_CannotSendEmptyTelemetry, "Cannot send empty telemetry"));
                        return;
                    }
                    if (!this._sender) {
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_SenderNotInitialized, "Sender was not initialized"));
                        return;
                    }
            ...
            Sender.prototype._onError = function (payload, message, event) {
                ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_OnError, "Failed to send telemetry.", { message: message }));
                    ...
                    DataSanitizer.sanitizeKey = function (name) {
                        if (name) {
                            ...
                            if (name.length > DataSanitizer.MAX_NAME_LENGTH) {
                                ...
                                ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_NameTooLong, "name is too long.  It has been truncated to " + DataSanitizer.MAX_NAME_LENGTH + " characters.", { name: name }));
                            }
                        }
                        return name;
                    };
                    ...
                    DataSanitizer.sanitizeUrl = function (url) {
                        if (url) {
                            ...
                            if (url.length > DataSanitizer.MAX_URL_LENGTH) {
                                ...
                                ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_UrlTooLong, "url is too long, it has been trucated to " + DataSanitizer.MAX_URL_LENGTH + " characters.", { url: url }));
                            }
                        }
                        return url;
                    };
    ...
    (function (ApplicationInsights) {
        ...
        var TelemetryContext = (function () {
            ...
            TelemetryContext.prototype.track = function (envelope) {
                if (!envelope) {
                    ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_TrackArgumentsNotSpecified, "cannot call .track() with a null or undefined argument"));
                }
                else {
        ...
        (function (Telemetry) {
            ...
            var PageViewManager = (function () {
                ...
                PageViewManager.prototype.trackPageView = function (name, url, properties, measurements, duration) {
                    ...
                    if (!Telemetry.PageViewPerformance.isPerformanceTimingSupported()) {
                        ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_NavigationTimingNotSupported, "trackPageView: navigation timing API used for calculation of page duration is not supported in this bser. This page view will be collected without duration and timing info."));
                        return;
                    }
                    ...
                    try {
                        if (ApplicationInsights.Util.canUseSessionStorage()) {
                            if (ApplicationInsights.Util.getSessionStorage(this.prevPageVisitDataKeyName) != null) {
                                th new Error("Cannot call startPageVisit consecutively without first calling stopPageVisit");
                            }
    ...
    (function (ApplicationInsights) {
        ...
        var Timing = (function () {
            ...
            Timing.prototype.stop = function (name, url, properties, measurements) {
                ...
                if (isNaN(start)) {
                    ApplicationInsights._InternalLogging.thInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_StopCalledWithoutStart, "stop was called without a corresponding start.", { name: this._name, key: name }));
                }
                else {
                    var end = +new Date;
        ...
        var Initialization = (function () {
            function Initialization(snippet) {
                ...
                if (config && !config.instrumentationKey) {
                    ...
                    if (config["iKey"]) {
                        ...
                        th new Error("Cannot load Application Insights SDK, no instrumentationKey was provided.");
                    }
                }
            ...
            Initialization.prototype.emptyQueue = function () {
                try {
                    ...
                    Microsoft.ApplicationInsights._InternalLogging.thInternalNonUserActionable(ApplicationInsights.LoggingSeverity.WARNING, message);
                }
            };
            ...
            Initialization.prototype.addHousekeepingBeforeUnload = function (appInsightsInstance) {
                ...
                if (!appInsightsInstance.config.disableFlushOnBeforeUnload && ('onbeforeunload' in window)) {
                    ...
                    if (!Microsoft.ApplicationInsights.Util.addEventHandler('beforeunload', performHousekeeping)) {
                        Microsoft.ApplicationInsights._InternalLogging.thInternalNonUserActionable(Microsoft.ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_FailedToAddHandlerForOnBeforeUnload, 'Could not add handler for beforeunload'));
                    }
                }
            };
